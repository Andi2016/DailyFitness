...
public class FitnessActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_search_main).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FitnessActivity.this, SearchActivity.class));
                //finish();
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_my_profile) {
            startActivity(new Intent(FitnessActivity.this, MyProfile.class));
